...
from sqft_config import FinetuneConfig
...
def main():
    parser = argparse.ArgumentParser(description="Runner for llm_on_ray-sqft")
    ...
    from llm_on_ray.finetune.finetune import main as llm_on_ray_sqft_main

    llm_on_ray_sqft_main(finetune_config)
